...
void main() {
    ...
    vec4 rawColor = Bloom(tex0, uv) * 0.5 + TiltShift(tex0, uv) * 0.7;// * (1.0-chroma) + CalculateChromaticAberration(tex0, uv) * chroma;
