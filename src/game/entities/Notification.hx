...
class Notification extends Text {
    ...
    static public function Toast(options :ToastOptions) :Notification {
        ...
        var textSize = (options.textSize != null ? options.textSize : 28);
        return new Notification({
            ...
            // backgroundColor: (options.backgroundColor != null ? options.backgroundColor : new Color(1, 1, 1, 0.0)),
            point_size: textSize,
            ...
            scene: options.scene,
            depth: 1000,
            duration: (options.duration != null ? options.duration : 6)
        });
    }
}
